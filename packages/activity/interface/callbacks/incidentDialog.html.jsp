...
<%
    if (context == null) {
        ...
        RecordList workInfoRecords = connector.search("Incident Work Info", "By Incident Id", parameters, metadata, attributes);
        out.clear();
%>
<div class="sourceDetails" title="Incident Details">
    ...
    <div class="info">
		...
		<div class="value"><a href="javascript:;" onclick="catalogHelper.popUpFulfillmentTypeDetails('incident')"><%= incidentRecord.get("Priority")%></a></div>
        ...
        <div class="value dateTime"><%= incidentRecord.get("Updated At")%></div>
        <div class="clear"></div>
