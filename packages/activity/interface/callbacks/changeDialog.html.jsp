...
<%
    if (context == null) {
        ...
        parameters.clear();
        parameters.put("Change Id", id);
        String[] attributes = new String[]{"Source", "Type", "Created At", "Summary" };
...
<div class="sourceDetails" title="Change Details">
    ...
    <div class="info">
		...
		<div class="value"><%= changeRecord.get("Priority")%></div>
        ...
        <div class="value dateTime"><%= changeRecord.get("Updated At")%></div>
        <div class="clear"></div>
    ...
    <div class="workLog">
        ...
        <div class="workInfo <%= zebraCycle.cycle()%>">
            ...
            <div class="clear"></div>
			<div class="label">Created At</div>
            <div class="value"><%= workInfo.get("Created At")%></div>
            <div class="clear"></div>
			<div class="label">Summary</div>
            <div class="value"><%= workInfo.get("Summary")%></div>
            <div class="clear"></div>
			<div class="label">Details</div>
            <div class="value"><%= workInfo.get("Details").replaceAll("\n","<br>")%></div>
            <div class="clear"></div>
        </div>
        <% } %>
    </div>
