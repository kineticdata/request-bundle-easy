...
<%-- @include file="../../../jsp/helpers/localize.jspf" --%>
...
<%
	...
	if (context == null) {
        ...
        SubmissionKlean submission = SubmissionKlean.findByInstanceId(context, csrv);
...
<div class="submissionDetails" title="Submission Details">
    <div class="header">
        <div class="requestId">
			<a title="<%-- =ThemeLocalizer.getString(catalogResourceBundle,"View request entry details")--%>View request entry details" href="/kinetic/ReviewRequest?csrv=<%=submission.getId()%>&reviewPage=<%= bundle.getProperty("reviewJsp")%>">
