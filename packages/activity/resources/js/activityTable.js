...
BUNDLE.ajaxRetry = function(options) {
    var newOptions = jQuery.extend(true, {}, options);
	newOptions['error'] = undefined;
    if ( newOptions['statusCode'] == undefined ) {
        newOptions['statusCode'] = {};
    }
    if ( newOptions['statusCode'][500] == undefined ) {
        newOptions['statusCode'][500] = function() {
            jQuery.ajax(options);
        }
    }
...
ActivityTable.prototype.doRequest = function(offsets, callback) {
	...
	if (this.searchValue) {data["searchValue"] = this.searchValue;}
